...
public class Compressor {
	...
	public static Cell[] uncompressMap(String d) {
		...
		for (int i = 0; i < data.length / 10; i++) {
			...
			cells[i] = new Cell(id, lineOfSight, layerGroundRot, groundLevel, movement, layerGroundNum, groundSlope, layerGroundFlip, layerObject1Num, layerObject1Rot, layerObject1Flip,
