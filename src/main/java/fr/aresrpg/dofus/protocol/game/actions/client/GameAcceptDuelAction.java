 ...
 * @since
 */
public class GameAcceptDuelAction implements GameAction {
	 ...
	 * @param targetId
	 */
	public GameAcceptDuelAction(long targetId) {
		this.targetId = targetId;
	}

	public GameAcceptDuelAction() {
	}
	...
	public String toString() {
		return "GameAcceptDuelAction [targetId=" + targetId + "]";
	}
